...
\lstinputlisting[firstline=1,lastline=1,title=1c\_output]{Code_output/output1c}
...
\lstinputlisting[firstline=500,lastline=509,title=1d\_output]{Code_output/output1d}
...
\lstinputlisting[firstline=1,lastline=10,title=1ePig\_output]{Code_output/output1e}
...
\lstinputlisting[firstline=500,lastline=510,title=1f\_output]{Code_output/output1f}
...
\lstinputlisting[firstline=1,lastline=1,title=2a\_output]{Code_output/output2a}
...
\textbf{Notes/Reflection}: Here the implementation of cleanBody is modified with a join function as cleanBody returns a list where we want a string. Since usernames can contain spaces, we elected to instead use | as a separator in hadoop.
 \lstinputlisting[firstline=500,lastline=510,title=2b\_output]{Code_output/output2b}
...
\lstinputlisting[firstline=1,lastline=10,title=2c\_output]{Code_output/output2c}
...
\lstinputlisting[firstline=1,lastline=10,title=2d\_output]{Code_output/output2d}
...
\lstinputlisting[firstline=1,lastline=10,title=2e\_output]{Code_output/output2e}
...
\lstinputlisting[firstline=1,lastline=10,title=2f\_output]{Code_output/output2f}
...
\lstinputlisting[firstline=1,lastline=10,title=2g\_output]{Code_output/output2g}
...
\lstinputlisting[firstline=1,lastline=21,title=2h\_output]{Code_output/output2h}
...
\lstinputlisting[firstline=1,lastline=10,title=2i\_output]{Code_output/output2i}
...
\lstinputlisting[firstline=1,lastline=10,title=3a\_output]{Code_output/output3a}
...
\lstinputlisting[firstline=1,lastline=10,title=3b\_output]{Code_output/output3b}
...
\lstinputlisting[firstline=1,lastline=10,title=3c\_output]{Code_output/output1a}
...
\lstinputlisting[firstline=1,lastline=10,title=3d\_output]{Code_output/output3d}
...
\lstinputlisting[firstline=1792,lastline=1800, title=4a\_output]{Code_output/output4a}
